...
public class Domath {
	...
	public static void main(String[] args) {
		...
		System.out.println(Calculate2.square(2) );
		System.out.println(Calculate2.cube(2));
		System.out.println(Calculate2.average(2.0,3.0));
		System.out.println(Calculate2.average(2.0,3.0,4.0));
		System.out.println(Calculate2.toDegrees(3.6));
		System.out.println(Calculate2.toRadians(60.0));
		...
		System.out.println(Calculate2.min(3,5));
